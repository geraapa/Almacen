...
namespace AlmacenSistemaTG.Controllers
{
    public class MarcasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "iIdMarca,vchDescripcion,vchClave")] Marca marca)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "iIdMarca,vchDescripcion,vchClave")] Marca marca)
        {
            if (ModelState.IsValid)
            {
